...
if edad < 18:
    print(f"Credito denegado!! Usted tiene {edad} años")
else:
...
if (credito_aprobado == True) and(edad > 18) and (edad < 80):
    print("Su prestamo puede ser otorgado hasta en 24 cuotas")
elif (credito_aprobado == True) and (edad >= 80):
    print(f"Por su edad de {edad} años, su prestamo no puede superar las 12 cuotas")
else:
    pass
